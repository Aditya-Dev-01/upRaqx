...
const AddNew = () => {
    ...
    return (
        <div className="p-8 sm:py-10 lg:pt-20 lg:pb-0 sm:px-20 lg:px-40 flex flex-col gap-10 min-h-[calc(100vh-120px)]">
            <div className="flex justify-between items-center text-white">
                <div className="flex items-center justify-center gap-5">
                    <h1 className="text-[20px] sm:text-[24px] md:text-[32px] text-white font-[500]">
                        {t('createMovie')}
                    </h1>
                </div>
            </div>
