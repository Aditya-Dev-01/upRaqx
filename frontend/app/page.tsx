      ...
      {loading ? (
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="flex flex-col gap-10 items-center w-auto sm:w-[400px] px-10">
            <h1 className="text-[32px] md:text-[48px] text-white font-[500]">{t('signin')}</h1>
            <div className="w-full flex flex-col gap-3">
              ...
              <div className="flex justify-center items-center gap-4 mb-4">
                ...
                <span className="text-white">{t('rememberMe')}</span> {/* Translate Remember Me */}
              </div>

              <PrimaryButton type="submit" className="bg-[#2BD17E]">{t('signin')}</PrimaryButton>
            </div>
          </div>
        </form>
      )}
